export const PUBLIC_KNOWLEDGE_VERSION = "2026-09-17-final-editorial";
...
export function resolvePublicNavigation(question) {
  ...
  if (includesAny(value, ["capella", "capstone", "experiential learning", "applied learning", "work based learning", "workforce development", "graduate learner", "cybersecurity learner", "academic industry", "university collaboration", "student project", "iam", "grc"])) {
  ...
  if (includesAny(value, ["cloud credit", "cloud credits", "ai credit", "ai credits", "technology credit", "sponsor", "sponsorship", "funder", "funding", "in kind", "technology partner"])) return normalizePublicAnswer({ answer: "Financial and in kind support can be tied to a defined health access activity, applied learning engagement, research output or technology use case. The Foundation separates support from editorial and evidence conclusions.", linkKeys: ["support", "partner", "appliedLearning"], boundary: "none" });
