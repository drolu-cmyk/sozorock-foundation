...
export function PublicationAccessPage({ publication }) {
  ...
  const submitAccess = async (event) => {
    ...
    const payload = {
      ...
      lastName,
      email,
      organization: organization || "Independent reader",
      sector: sector || "Individual or family",
      cityOrRegion: cityOrRegion || "Not provided",
      state: "Not provided",
      country: "Not provided",
      reason: reason || "Requested access to a public-interest publication for reading and reference.",
