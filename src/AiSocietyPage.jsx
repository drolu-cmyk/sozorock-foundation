...
export function AiSocietyPage() {
  return <>
    <PageHero eyebrow="AI & Society" title="Who should have a say?" copy="When AI affects learning, work or access to opportunity, people affected should help shape the rules. We are developing a community-governance approach grounded in evidence, human judgment and the right to question a decision.">
      <div className="button-row"><Link href="/ai-society#approach" className="button button-light">Explore the approach</Link><Link href="/ai-society#participate" className="button button-outline-light">Participate</Link></div>
    </PageHero>
    <section className="section society-introduction" id="who-decides"><div className="shell society-intro-layout">
      ...
      <div><p><strong>Who Decides?</strong> is a developing AI &amp; Society initiative designed to turn community participation into documented questions, decision records and institutional responses for consequential AI in learning and work.</p><p>Students, educators, workers and job seekers would identify priorities, examine evidence, test decision scenarios and develop recommendations. Participating institutions would be invited to state what they can change, what requires further evidence and what remains unresolved.</p><p>Initial convenings and sample records will proceed as participation, funding, accessibility support and appropriate institutional partners are secured.</p></div>
    </div></section>
    <DecisionQuestions />
    ...
    <section className="section form-section" id="participate"><div className="shell form-layout">
      <div><h2>Help shape the questions.</h2><p>Technical expertise is not required. Bring a perspective from learning, teaching, working or applying for work.</p><p>Expressions of interest help inform future convenings. They do not reserve an event place or establish a partnership.</p><p className="society-support-case"><strong>What support enables.</strong> Participant compensation, facilitation, accessibility, independent review and public documentation. Institutional partners may contribute venues, participant access, domain expertise, evaluation or in-kind technology without directing findings.</p><p><Link href="/partner#conversation" className="text-link">Host or contribute to future work</Link></p><p><Link href="/support" className="text-link">Discuss support</Link></p></div>
