    ...
    <>
      ...
      <section className="learning-governance" aria-labelledby="learning-governance-title">
        <div className="shell learning-governance-inner">
          ...
          <p>Capella University faculty retain course ownership, academic oversight and grading. Dr. Oluwabiyi Adeyemo designs the experiential project tasks, mentors learners and evaluates their applied work for SozoRock.</p>
          <p>Faculty assessment is evidence about the engagement, not a university endorsement of the Foundation.</p>
        </div>
      </section>
