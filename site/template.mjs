import { leadership, publications, externalDestinations } from './content.mjs';
...
export function header(path = '/') {
  return `<header class="site-header" data-header><div class="shell header-inner">${logo}<button class="mobile-toggle" type="button" data-mobile-toggle aria-expanded="false" aria-controls="primary-navigation" aria-label="Open menu"><span></span><span></span></button><nav class="primary-nav" id="primary-navigation" data-primary-nav aria-label="Primary">
  ${megaMenu({label:'Work',key:'work',heading:'What SozoRock operates',allLabel:'View all work',allHref:'/work',items:[['SozoRock Global Institute','Insight, publications, and convening','/work/global-institute'],['SozoRock Health','Health access and community evidence',externalDestinations.health],['SozoRock AI Lab','Applied learning for modern work',externalDestinations.aiLab]]})}
  ...
  ${megaMenu({label:'About',key:'about',heading:'Why SozoRock exists',allLabel:'View all about',allHref:'/about',items:[['Mission','What the Foundation is here to do','/about'],['Leadership','People leading the work','/leadership'],['Standards','How the Foundation works','/standards'],['Contact','Reach the Foundation','mailto:contact@sozorockfoundation.org']]})}
  <a class="nav-direct" href="/partner">Partner</a><a class="nav-direct" href="/support">Support</a></nav></div></header>`;
}

export function footer() {
  return `<footer class="site-footer"><div class="shell footer-main"><div class="footer-brand">${logo}</div><div><h2>Work</h2><a href="/work/global-institute">Global Institute</a><a href="${externalDestinations.health}">SozoRock Health</a><a href="${externalDestinations.cbcap}">CB-CAP</a><a href="${externalDestinations.aiLab}">SozoRock AI Lab</a></div><div><h2>Ideas</h2><a href="/publications">Publications</a><a href="/insights">Insights</a><a href="/events">Events</a></div><div><h2>Foundation</h2><a href="/about">About</a><a href="/leadership">Leadership</a><a href="/standards">Standards</a></div><div><h2>Engage</h2><a href="/partner">Partner</a><a href="/support">Support</a><a href="mailto:contact@sozorockfoundation.org">Contact</a></div></div><div class="shell footer-bottom"><div class="legal-copy"><p>© 2026 The SozoRock Foundation, Inc. All rights reserved.</p><p>The SozoRock Foundation, Inc. is a U.S. nonprofit, tax-exempt charitable organization under Section 501(c)(3) of the Internal Revenue Code. EIN: 39-4736725. Contributions are tax-deductible to the extent permitted by law.</p><p>SozoRock® is a registered trademark of SozoRock Tech Inc., used under license by The SozoRock Foundation.</p></div><div class="footer-meta"><div><a href="/standards#accessibility">Accessibility</a><a href="/standards#privacy">Privacy</a><a href="/standards#nondiscrimination">Nondiscrimination</a></div><div><a href="https://x.com/srockfoundation" rel="me">X</a><a href="https://www.youtube.com/@srockfoundation">YouTube</a></div></div></div></footer>`;
}
...
const cover = p => `<img src="${p.cover}" alt="${esc(p.title)} cover" loading="lazy">`;
...
export const leadershipCards = () => leadership.map(person => `<article class="person"><img src="${person.image}" alt="Portrait of ${esc(person.name)}" loading="lazy"><div><h2>${person.name}${person.credentials ? `, ${person.credentials}` : ''}</h2><p class="person-title">${person.title}</p><p>${person.bio}</p></div></article>`).join('');
